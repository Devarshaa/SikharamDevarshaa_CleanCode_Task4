...
public class Interest {
	...
	float type(int choice)
	{
		switch(choice)
		{
		case 1:System.out.print("Simple ");
				return simpleInterest(this.principal,this.time,this.rate);
		case 2:System.out.print("Compound ");
			return compoundInterest(this.principal,this.time,this.rate);
		}
		return 0;
	}
